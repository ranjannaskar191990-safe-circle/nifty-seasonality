...
export default function Home() {
  ...
  // NEW: Portfolio Tracking State (Maps month index to an array of selected symbols)
  ...
  // NEW: Toggle a stock in or out of the portfolio for the currently selected month
  ...
  // NEW: Remove a stock directly from the side panel
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-50">
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-3 gap-6">
                {finalDisplayData.map((stock, index) => {
                  ...
                  // Check if this stock is currently selected for trading in the active month
      ...
      {/* NEW: 12-MONTH PORTFOLIO SIDEBAR */}
      <aside className="w-full lg:w-80 xl:w-96 bg-white border-l border-gray-200 shadow-lg lg:h-screen lg:sticky lg:top-0 overflow-y-auto flex flex-col">
        <div className="p-6 border-b border-gray-200 bg-gray-50 sticky top-0 z-10">
          ...
          <p className="text-sm text-gray-500 mt-1">Your planned setups by month</p>
        </div>
            ...
            return (
              <div key={mIndex} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                <div className="flex justify-between items-center mb-3">
                  <h3 className={`font-bold ${mIndex === selectedMonth ? 'text-blue-600' : 'text-gray-700'}`}>
                    {monthName}
                  </h3>
                  <span className="text-xs font-medium bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full">
                    {stocksForMonth.length}
                  </span>
                </div>
                ...
                {stocksForMonth.length === 0 ? (
                  ...
                  <ul className="space-y-2">
                    {stocksForMonth.map(sym => (
                      <li key={sym} className="flex justify-between items-center text-sm bg-gray-50 border border-gray-200 rounded p-2">
